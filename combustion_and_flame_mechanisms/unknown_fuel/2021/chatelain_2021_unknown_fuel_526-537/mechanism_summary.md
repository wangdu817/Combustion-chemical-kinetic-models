...
- Species count: not parsed
- Reaction count: not parsed
- Message: CanteraError: ******************************************************************************* InputFileError thrown by setupPhase: Error on line 11 of /home/icaurs/Combustion-chemical-kinetic-models/combustion_and_flame_mechanisms/unknown_fuel/2021/chatelain_2021_unknown_fuel_526-537/mechanism.yaml: Could not parse elements declaration of type 'vector<AnyValue>' | Line | | 6 | units: {length: cm, time: s, quantity: mol, activation-energy: cal/mol} | 7 | | 8 | phases: | 9 | - name: gas | 10 | thermo: ideal-gas > 11 > elements: [] ^ | 12 | species: [] | 13 | transport: mixture-averaged | 14 | state: {T: 300.0, P: 1 atm} *******************************************************************************
- Method: cantera
