...
- Original mechanism source files: _processing/extracted/s0010218024005741_mmc2/JIHT-OHex(CxHy)_kin.dat, _processing/extracted/s0010218024005741_mmc3/JIHT-OHex(CxHy).yaml
- Original thermodynamic source files: _processing/extracted/s0010218024005741_mmc2/JIHT-OHex(CxHy)_therm.dat, _processing/extracted/s0010218024005741_mmc3/JIHT-OHex(CxHy).yaml
...
- Species count: 1
- Reaction count: 77
- Message: CanteraError: ******************************************************************************* InputFileError thrown by addSpecies: Error on lines 65 and 74 of /home/icaurs/Combustion-chemical-kinetic-models/combustion_and_flame_mechanisms/methane_hydrogen/2025/loukhovitski_2025_methane_hydrogen_113865/mechanism.yaml: Could not find a species named 'H'. | Line | | 60 | - name: "JIHT-OHex(CxHy)" | 61 | transport: multicomponent | 62 | kinetics: gas | 63 | thermo: ideal-gas | 64 | elements: [H, O, N, Ar, He, Kr, C] > 65 > species: [H, H2, O, O2, OH, H2O, N2, HO2, H2O2, AR, HE, KR, OHEX, NO, N2O, NO2, ^ | 66 | HNO, HNO2, NH3, NH, NNH, CO, CO2, CH4, CH3, CH2, C, CH, CH3OH, CH2OH, | 67 | CH2O, HCO, C2H6, C2H4, C2H2, C2H, CH3CO, CH2CO, C3H6, C3H5, C3H4, | 68 | C3H3, C3H2, C2H3CHO, C4H10, C4H6, C4 ... [truncated; see _processing logs]
- Method: cantera
