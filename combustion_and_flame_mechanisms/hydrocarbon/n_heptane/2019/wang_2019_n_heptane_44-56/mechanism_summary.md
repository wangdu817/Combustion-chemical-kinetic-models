...
Xiaohan Wang, Qianshi Song, Yong Wu, Xing Li, Tao Li, Xiaojun Zeng. Modelling and numerical simulation of n-heptane pyrolysis coking characteristics in a millimetre-sized tube reactor[J]. Combustion and Flame, 2019, 201: 44-56. DOI: 10.1016/j.combustflame.2018.12.006.

## Metadata

- Journal: Combustion and Flame
- Volume/issue month: 201 / Mar
- Article number: 44-56
- DOI: 10.1016/j.combustflame.2018.12.006
- ScienceDirect URL: https://www.sciencedirect.com/science/article/pii/S0010218018305236
...
- Original mechanism source files: _processing/extracted/s0010218018305236_mmc2/Simplified surface reaction mechanism.dat, _processing/extracted/s0010218018305236_mmc1/Gaseous pyrolysis mechanism for n-heptane.dat
- Original thermodynamic source files: _processing/extracted/s0010218018305236_mmc2/Simplified surface reaction mechanism.dat, _processing/extracted/s0010218018305236_mmc3/Therm.dat
- Original transport source files: _processing/extracted/s0010218018305236_mmc4/Trans.dat
...
- Message: InputError: Error while reading entry in chem.inp starting on line 24: """ BULK/DepC/ C(B) /1.8/ """ Section starts with unrecognized keyword 'BULK/DepC/ C(B) /1.8/' Error while reading section in chem.inp starting on line 24: """ BULK/DepC/ C(B) /1.8/ """ Surface phase input file must be specified using the '--surface' option with the bulk (gas) phase input specified using the '--input' option. Error while reading entry in therm.dat starting on line 24: """ BULK/DepC/ C(B) /1.8/ """ Section starts with unrecognized keyword 'BULK/DepC/ C(B) /1.8/' Error while reading section in therm.dat starting on line 24: """ BULK/DepC/ C(B) /1.8/ """ Surface phase input file must be specified using the '--surface' option with the bulk (gas) phase input specified using the '--input' option. Please check ... [truncated; see _processing logs]
- Method: cantera
...
- extracted S0010218018305236_mmc4.zip
- extracted S0010218018305236_mmc1.zip
- extracted S0010218018305236_mmc3.zip
- extracted S0010218018305236_mmc2.zip
