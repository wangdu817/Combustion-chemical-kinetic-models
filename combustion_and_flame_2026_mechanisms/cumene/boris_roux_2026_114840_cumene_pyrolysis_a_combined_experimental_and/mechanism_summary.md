...
- Original mechanism source files: extracted\s0010218026000763_mmc2\SM1_Mechanism_R.inp
- Original thermodynamic source files: extracted\s0010218026000763_mmc3\SM2_NASA_polynomial_R.dat
...
- Message: ValueError: could not convert string to float: '5.00+11'; numeric cleanup retry failed: ValueError: could not convert string to float: 'r-cis-stilbene'
- Method: cantera
