...
- Original mechanism source files: raw_downloads\S0010218026002737_mmc2.txt
- Original thermodynamic source files: raw_downloads\S0010218026002737_mmc3.txt
...
- Message: InputError: Unexpected token "C2H5CN+CH2CN" in reaction expression "C2H5CN+CH2CN=NCCH2CN+C2H5
".
